=== Palm Beach Pro ===
Plugin URL: https://themezee.com/addons/palm-beach-pro/
...
Adds additional features and customization options to the Palm Beach theme.

== Description ==

The *Palm Beach Pro* plugin adds additional features to the Palm Beach theme.
...
1. Install the Palm Beach Pro Plugin on Plugins -> Add New -> Upload Plugin by uploading the .ZIP plugin file.
...
Please see our [Palm Beach Theme Documentation](https://themezee.com/docs/palm-beach-documentation/ "Palm Beach Theme Documentation").
