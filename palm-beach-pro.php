...
class Palm_Beach_Pro {
	...
	static function constants() {
		...
		define( 'PALM_BEACH_PRO_VERSION', '2.0.3' );
	...
	static function includes() {
		...
		require_once PALM_BEACH_PRO_PLUGIN_DIR . 'includes/modules/class-block-colors.php';
	...
	static function enqueue_styles() {
		...
		// Enqueue Custom CSS.
		wp_add_inline_style( 'palm-beach-pro', self::get_custom_css() );
	}
	...
	static function enqueue_editor_styles() {
		...
		// Enqueue Custom CSS.
		wp_add_inline_style( 'palm-beach-editor-styles', self::get_custom_css() );
	}
