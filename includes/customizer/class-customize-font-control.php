...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class Palm_Beach_Pro_Customize_Font_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => __( 'Previous Font', 'palm-beach-pro' ),
				'next' => __( 'Next Font', 'palm-beach-pro' ),
				'standard' => _x( 'Default', 'default font button', 'palm-beach-pro' ),
			);
			...
			// Set Fonts.
			$this->fonts = Palm_Beach_Pro_Custom_Font_Lists::get_fonts( $theme_options['available_fonts'] );
