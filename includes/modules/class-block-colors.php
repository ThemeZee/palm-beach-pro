 ...
 * Block Colors Class
 */
class Palm_Beach_Pro_Block_Colors {
	...
	static function color_settings( $wp_customize ) {
		...
		$wp_customize->add_section( 'palm_beach_pro_section_block_colors', array(
			'title'    => esc_html__( 'Block Colors', 'palm-beach-pro' ),
			'priority' => 55,
		...
		$wp_customize->add_setting( 'palm_beach_theme_options[primary_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'palm_beach_theme_options[primary_color]', array(
				'label'    => esc_html_x( 'Primary', 'Color Option', 'palm-beach-pro' ),
				'section'  => 'palm_beach_pro_section_block_colors',
				'settings' => 'palm_beach_theme_options[primary_color]',
				'priority' => 10,
			)
		) );

		// Add Secondary Color setting.
		$wp_customize->add_setting( 'palm_beach_theme_options[secondary_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'palm_beach_theme_options[secondary_color]', array(
				'label'    => esc_html_x( 'Secondary', 'Color Option', 'palm-beach-pro' ),
				'section'  => 'palm_beach_pro_section_block_colors',
				'settings' => 'palm_beach_theme_options[secondary_color]',
				'priority' => 20,
			)
		) );

		// Add Tertiary Color setting.
		$wp_customize->add_setting( 'palm_beach_theme_options[tertiary_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'palm_beach_theme_options[tertiary_color]', array(
				'label'    => esc_html_x( 'Tertiary', 'Color Option', 'palm-beach-pro' ),
				'section'  => 'palm_beach_pro_section_block_colors',
				'settings' => 'palm_beach_theme_options[tertiary_color]',
				'priority' => 30,
			)
		) );

		// Add Accent Color setting.
		$wp_customize->add_setting( 'palm_beach_theme_options[accent_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'palm_beach_theme_options[accent_color]', array(
				'label'    => esc_html_x( 'Accent', 'Color Option', 'palm-beach-pro' ),
				'section'  => 'palm_beach_pro_section_block_colors',
				'settings' => 'palm_beach_theme_options[accent_color]',
				'priority' => 40,
			)
		) );

		// Add Highlight Color setting.
		$wp_customize->add_setting( 'palm_beach_theme_options[highlight_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'palm_beach_theme_options[highlight_color]', array(
				'label'    => esc_html_x( 'Highlight', 'Color Option', 'palm-beach-pro' ),
				'section'  => 'palm_beach_pro_section_block_colors',
				'settings' => 'palm_beach_theme_options[highlight_color]',
				'priority' => 50,
			)
		) );

		// Add Light Gray Color setting.
		$wp_customize->add_setting( 'palm_beach_theme_options[light_gray_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'palm_beach_theme_options[light_gray_color]', array(
				'label'    => esc_html_x( 'Light Gray', 'Color Option', 'palm-beach-pro' ),
				'section'  => 'palm_beach_pro_section_block_colors',
				'settings' => 'palm_beach_theme_options[light_gray_color]',
				'priority' => 60,
			)
		) );

		// Add Gray Color setting.
		$wp_customize->add_setting( 'palm_beach_theme_options[gray_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'palm_beach_theme_options[gray_color]', array(
				'label'    => esc_html_x( 'Gray', 'Color Option', 'palm-beach-pro' ),
				'section'  => 'palm_beach_pro_section_block_colors',
				'settings' => 'palm_beach_theme_options[gray_color]',
				'priority' => 70,
			)
		) );

		// Add Dark Gray Color setting.
		$wp_customize->add_setting( 'palm_beach_theme_options[dark_gray_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'palm_beach_theme_options[dark_gray_color]', array(
				'label'    => esc_html_x( 'Dark Gray', 'Color Option', 'palm-beach-pro' ),
				'section'  => 'palm_beach_pro_section_block_colors',
				'settings' => 'palm_beach_theme_options[dark_gray_color]',
				'priority' => 80,
			)
		) );
	}
...
// Run Class.
add_action( 'init', array( 'Palm_Beach_Pro_Block_Colors', 'setup' ) );
add_filter( 'palm_beach_color_palette', array( 'Palm_Beach_Pro_Block_Colors', 'block_color_palette' ) );
