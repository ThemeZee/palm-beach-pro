...
class Palm_Beach_Pro_Custom_Fonts {
	...
	static function setup() {
		...
		require_once PALM_BEACH_PRO_PLUGIN_DIR . '/includes/customizer/class-font-list.php';
		require_once PALM_BEACH_PRO_PLUGIN_DIR . '/includes/customizer/class-customize-font-control.php';
		require_once PALM_BEACH_PRO_PLUGIN_DIR . '/includes/customizer/class-customize-font-list-control.php';

		// Add Custom Color CSS code to custom stylesheet output.
		add_filter( 'palm_beach_pro_custom_css_stylesheet', array( __CLASS__, 'custom_fonts_css' ) );

		// Load custom fonts from Google web font API.
		add_filter( 'palm_beach_google_fonts_url', array( __CLASS__, 'google_fonts_url' ) );
	 ...
	 *
	 * @uses palm_beach_google_fonts_url filter hook
	...
	static function google_fonts_url( $google_fonts_url ) {
		...
		$default_fonts = Palm_Beach_Pro_Custom_Font_Lists::default_browser_fonts();
	...
	static function font_settings( $wp_customize ) {
		...
		$wp_customize->add_section( 'palm_beach_pro_section_fonts', array(
			'title'    => __( 'Theme Fonts', 'palm-beach-pro' ),
			'priority' => 70,
		...
		$wp_customize->add_control( new Palm_Beach_Pro_Customize_Font_Control(
			$wp_customize, 'text_font', array(
				'label'      => __( 'Base Font', 'palm-beach-pro' ),
		...
		$wp_customize->add_control( new Palm_Beach_Pro_Customize_Font_Control(
			$wp_customize, 'title_font', array(
				'label'      => _x( 'Headings', 'font setting', 'palm-beach-pro' ),
				'section'    => 'palm_beach_pro_section_fonts',
		...
		$wp_customize->add_control( new Palm_Beach_Pro_Customize_Font_Control(
			$wp_customize, 'navi_font', array(
				'label'      => _x( 'Navigation', 'font setting', 'palm-beach-pro' ),
				'section'    => 'palm_beach_pro_section_fonts',
		...
		$wp_customize->add_setting( 'palm_beach_theme_options[available_fonts]', array(
			'default'           => 'favorites',
			'type'           	=> 'option',
			'transport'         => 'postMessage',
			'sanitize_callback' => array( 'Palm_Beach_Pro_Custom_Fonts', 'sanitize_available_fonts' ),
			)
		);
		$wp_customize->add_control( new Palm_Beach_Pro_Customize_Font_List_Control(
			$wp_customize, 'palm_beach_control_available_fonts', array(
				'label'      => __( 'Choose available Fonts', 'palm-beach-pro' ),
				'section'    => 'palm_beach_pro_section_fonts',
				'settings'   => 'palm_beach_theme_options[available_fonts]',
				'choices' => array(
					'default' => __( 'Default Browser Fonts (12)', 'palm-beach-pro' ),
					'favorites' => __( 'ThemeZee Favorite Fonts (35)', 'palm-beach-pro' ),
					'popular' => __( 'Most Popular Google Fonts (100)', 'palm-beach-pro' ),
					'all' => __( 'All Google Fonts (650)', 'palm-beach-pro' ),
					),
				'priority' => 5,
			)
		) );
