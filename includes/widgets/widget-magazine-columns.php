...
class Palm_Beach_Pro_Magazine_Columns_Widget extends WP_Widget {
	...
	function render( $args, $settings ) {
		...
		// Get cached post ids.
		$post_ids_category_one = palm_beach_get_magazine_post_ids( $this->id . '-left-category', $settings['category_one'], $settings['number'] );
		$post_ids_category_two = palm_beach_get_magazine_post_ids( $this->id . '-right-category', $settings['category_two'], $settings['number'] );
		?>
	...
	function category_title( $args, $settings, $category_id, $category_title ) {
		...
		if ( ! empty( $widget_title ) ) :
			...
			$widget_title = palm_beach_magazine_widget_title( $widget_title, $category_id );
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'category_one_title' ); ?>"><?php esc_html_e( 'Left Category Title:', 'palm-beach-pro' ); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'category_one' ); ?>"><?php esc_html_e( 'Left Category:', 'palm-beach-pro' ); ?></label><br/>
			...
			?>
				...
				<p>
			<label for="<?php echo $this->get_field_id( 'category_two_title' ); ?>"><?php esc_html_e( 'Right Category Title:', 'palm-beach-pro' ); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'category_two' ); ?>"><?php esc_html_e( 'Right Category:', 'palm-beach-pro' ); ?></label><br/>
			<?php // Display Category One Select.
				$args = array(
					'show_option_all'    => esc_html__( 'All Categories', 'palm-beach-pro' ),
					'show_count' 		 => true,
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Number of posts:', 'palm-beach-pro' ); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'highlight_post' ); ?>">
				...
				<?php esc_html_e( 'Highlight first post (big image + excerpt)', 'palm-beach-pro' ); ?>
			</label>
		</p>
